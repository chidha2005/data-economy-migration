...
var ChartComponent = /** @class */ (function () {
    ...
    ChartComponent.propDecorators = {
        ...
        chartElement: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"], args: ['chart',] }]
    };
...
var HistoryComponent = /** @class */ (function () {
    function HistoryComponent(route, historyService) {
        this.route = route;
        ...
        this.route.queryParams
            .filter(function (params) { return params.status; })
    ...
    HistoryComponent.prototype.ngOnInit = function () {
        ...
        this.historyService.getEmployeesList().subscribe(function (data) { return console.log(data); }, function (error) { return console.log(error); });
        /**
         * fetch data
         */
        this._fetchData();
     ...
     */
    HistoryComponent.prototype._fetchData = function () {
        this.masterList = [
            {
                requestNo: '1000',
    ...
    HistoryComponent.prototype.openReconDetails = function (selectedItem) {
        this.selectedRec = selectedItem;
        this.showMaster = false;
        this.showDetail = true;
    };
    HistoryComponent.prototype.cancelDetails = function () {
...
var HistoryService = /** @class */ (function () {
    ...
    HistoryService.prototype.getEmployeesList = function () {
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.ngOnInit = function () {
        ...
        this.requestStatusChartConfig = {
            ...
            events: {
                dataPointSelection: function (event, chartContext, config) {
                    _this.contentClicked('request', event, chartContext, config);
                }
            },
        ...
        this.reconStatusChartConfig = {
            ...
            events: {
                dataPointSelection: function (event, chartContext, config) {
                    _this.contentClicked('recon', event, chartContext, config);
                }
            },
            labels: ["Not Started", "In Progress", "Complete", "Error"]
        };
     ...
     * content refresh
     */
    HomeComponent.prototype.contentRefresh = function () {
        console.log('Data refresh requested');
    };
    HomeComponent.prototype.contentClicked = function (requestType, event, chartContext, config) {
        console.log(config);
     ...
     */
    HomeComponent.prototype.fetchChartData = function () {
        var _this = this;
        var res = [
            {
        ...
        res.forEach(function (ele) {
            var requestStatus = Object.assign({}, _this.requestStatusChartConfig, { "series": ele["requestStatus"] });
            var reconStatus = Object.assign({}, _this.reconStatusChartConfig, { "series": ele["reconStatus"] });
...
/* harmony import */ var ng_apexcharts__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ng-apexcharts */ "./node_modules/ng-apexcharts/fesm5/ng-apexcharts.js");
...
var ReconComponent = /** @class */ (function () {
     ...
     * fetches the table value
     */
    ReconComponent.prototype._fetchData = function () {
        this.masterList = [
            {
                requestNo: '1000',
                requestedBy: 'John Doe',
    ...
    ReconComponent.prototype.openReconDetails = function (selectedItem) {
        this.selectedRec = selectedItem;
        this.showMaster = false;
        this.showDetail = true;
    };
    ReconComponent.prototype.cancelDetails = function () {
        this.selectedRec = null;
        this.showMaster = true;
        this.showDetail = false;
    };
...
var RequestPreviewComponent = /** @class */ (function () {
    function RequestPreviewComponent(router) {
        this.router = router;
        this.previewList = [];
    }
    RequestPreviewComponent.prototype.ngOnInit = function () {
        // tslint:disable-next-line: max-line-length
     ...
     * fetches the table value
     */
    RequestPreviewComponent.prototype._fetchData = function () {
        this.previewList = [{
                sno: '1',
                dbName: 'DB1',
                tableName: "Table1",
    ...
    RequestPreviewComponent.prototype.onCancelFunction = function () {
    ...
    return RequestPreviewComponent;
}());
...
var RequestComponent = /** @class */ (function () {
    ...
    RequestComponent.prototype.fileSelectHandler = function (event, fileUploadRef) {
        var files = event.files;
        if (files.length > 0) {
            this.s3FilesList.push(files[0]);
        }
    };
    RequestComponent.prototype.tokenizationFileSelectHandler = function (event, fileUploadRef) {
        var files = event.files;
        if (files.length > 0) {
            this.tokenizationFilesList.push(files[0]);
        }
    };
    RequestComponent.prototype.onContinueFunction = function () {
...
var UserComponent = /** @class */ (function () {
    function UserComponent(confirmationService) {
        this.confirmationService = confirmationService;
        this.isAdd = false;
        this.isUpdate = false;
        this.userJson = {
    ...
    UserComponent.prototype.resetUserJson = function () {
        this.userJson = {
            userId: null,
            userName: "",
            email: "",
    ...
    UserComponent.prototype.showAddUser = function () {
        this.userJson =
            this.isAdd = true;
    };
    ;
    UserComponent.prototype.showUpdateUser = function (selectedUser) {
        this.userJson = selectedUser;
        this.isUpdate = true;
    };
    ;
    UserComponent.prototype.showDeleteUser = function (selectedUser) {
